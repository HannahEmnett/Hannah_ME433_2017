    ...
    switch (appData.state) {
        ...
        case APP_STATE_MOUSE_EMULATE:
            ...
            if (inc==4) {
                ...
                buff[0]=accval[4]; 
                buff[2]=accval[5];
                ix= (float) (buff[0]* w1 + buff[1]*w2)/200.0; 
                iy= (float) (buff[2]* w1 + buff[3]*w2)/200.0; 
                
//                xlen1=  (signed char) (ix)/300.0; 
//                ylen1= (signed char) (iy)/300.0; 
                xlen1 = (int8_t) ix;
                ylen1= (int8_t) iy;
//                if (ix>10 || iy>10) LATAbits.LATA4=1;
//                else LATAbits. LATA4=0;
                inc=1;
            }
            else {
            ...
            appData.mouseButton[0] = MOUSE_BUTTON_STATE_RELEASED;
            appData.mouseButton[1] = MOUSE_BUTTON_STATE_RELEASED;
            appData.xCoordinate = xlen1;
            appData.yCoordinate =  ylen1;
